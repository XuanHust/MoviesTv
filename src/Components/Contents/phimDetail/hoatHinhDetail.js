...
const HoatHinhDetail = (props) => {
    const phim = props.dataRedux.hoathinh.filter(e => e.movie._id === props.infor.movie._id)
    return (
...
export default connect(mapStateToProps)(HoatHinhDetail);
import './phimBoDetail.scss'
import { connect } from 'react-redux'

const PhimLeDetail = (props) => {
    const phim = props.dataRedux.phimle.filter(e => e.movie._id === props.infor.movie._id)
    return (
...
export default connect(mapStateToProps)(PhimLeDetail);